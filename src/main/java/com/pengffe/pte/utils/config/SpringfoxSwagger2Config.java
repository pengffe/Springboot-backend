package com.pengffe.pte.utils.config;

import com.google.common.base.Predicate;
import com.pengffe.pte.utils.annotation.SwaggerCustomIgnore;
...
@ComponentScan(basePackages = "com.pengffe.pte.modules.question.controller")
@ComponentScan(basePackages = "com.pengffe.pte.modules.authServer.controller")
@ComponentScan(basePackages = "com.pengffe.pte.modules.jobApplication")
public class SpringfoxSwagger2Config {
    ...
    private ApiInfo swaggerDemoApiInfo(){
        //构建联系实体，在UI界面会显示
        Contact contact = new Contact("Web-pte", "http://www.zaomianbao.com", "pengf190224@gmail.com");
